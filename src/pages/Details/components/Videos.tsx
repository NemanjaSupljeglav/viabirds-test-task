  ...
  return (
    <section className="bg-secondaryColor ">
      <div
        className={cn(
          maxWidth,
          `flex flex-col lg:gap-16 md:gap-14 sm:gap-12 xs:gap-10 gap-8  md:py-16 sm:py-12 xs:py-10 py-8`
        )}
      >
        {youtubeVideos.map(video => {
          return (
            ...
            >
              <h2 className="text-black  font-nunito font-semibold lg:text-[24px] md:text-[22.75px] sm:text-[18.75px] xs:text-[18px] text-[16.75px] mb-1">
                {video.name}
              </h2>
